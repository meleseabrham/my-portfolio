...
function SplashCursor({
	...
	useEffect(() => {
		...
		function getWebGLContext(canvasEl: HTMLCanvasElement) {
			...
			const gl2 = canvasEl.getContext("webgl2", params as any) as WebGL2RenderingContext | null;
			let gl: WebGLRenderingContext | WebGL2RenderingContext | null = gl2 as any;
			const isWebGL2 = !!gl2;
			if (!isWebGL2) {
				gl =
			...
			if (isWebGL2) {
				formatRGBA = getSupportedFormat(gl as any, (gl as WebGL2RenderingContext).RGBA16F, (gl as WebGL2RenderingContext).RGBA, halfFloatTexType);
				formatRG = getSupportedFormat(gl as any, (gl as WebGL2RenderingContext).RG16F, (gl as WebGL2RenderingContext).RG, halfFloatTexType);
				formatR = getSupportedFormat(gl as any, (gl as WebGL2RenderingContext).R16F, (gl as WebGL2RenderingContext).RED, halfFloatTexType);
			} else {
				formatRGBA = getSupportedFormat(gl as any, (gl as WebGLRenderingContext).RGBA, (gl as WebGLRenderingContext).RGBA, halfFloatTexType);
				formatRG = getSupportedFormat(gl as any, (gl as WebGLRenderingContext).RGBA, (gl as WebGLRenderingContext).RGBA, halfFloatTexType);
				formatR = getSupportedFormat(gl as any, (gl as WebGLRenderingContext).RGBA, (gl as WebGLRenderingContext).RGBA, halfFloatTexType);
			}
		...
		function getResolution(resolution: number) {
			let aspectRatio = (gl.drawingBufferWidth as number) / (gl.drawingBufferHeight as number);
